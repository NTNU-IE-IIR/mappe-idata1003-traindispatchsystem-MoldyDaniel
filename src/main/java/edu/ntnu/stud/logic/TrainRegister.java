 ...
 *   <li>{@link #fillTrainRegister()}: Fills the register with predefined train data
...
public class TrainRegister {
  ...
  /**
   * Fills the trainRegister with predefined trains.
   *
  ...
  public void fillTrainRegister() {
    ...
    this.addTrains(new Train("A124", "A1", "Oslo", "13:20", -11));
    this.addTrains(new Train("A125", "A1", "Bergen", "11:30", -91));
    this.addTrains(new Train("A126", "A1", "Bergen", "12:00", -11));
  }
